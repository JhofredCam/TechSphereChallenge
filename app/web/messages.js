(() => {
  ...
  const messages = {
    ...
    LISTEN_START: ["Te escucho. Tienes hasta {segundos} segundos para contarme cómo te sientes.", "Escuchando. Tienes {segundos} segundos."],
    ...
    LISTEN_TIMEOUT: ["No alcancé a escucharte. ¿Quieres intentarlo de nuevo?", "Se terminó el tiempo de escucha. Puedes reintentar o escribir."],
